    ...
    public partial class UrunDuzenle : Form
    {
       ...
       private void btnListele_Click(object sender, EventArgs e)
        ...
        private void btnGuncelle_Click(object sender, EventArgs e)
        {
            SqlConnection bg = new SqlConnection(ConnectionString);
            bg.Open();
            SqlCommand guncel = new SqlCommand("update FiyatListesi1 set urunIsim=@urunIsim, fiyat=@fiyat where urunId=@urunId", bg);
            ...
            int adisyonAdet = 1;
            bg.Open();
            SqlCommand cmd = new SqlCommand("select * from FiyatListesi1 where kategori='" + secilenUrunKategori + "' order by urunId", bg);
            SqlDataReader oku = cmd.ExecuteReader();
            while (oku.Read())
            {
                ListViewItem listele = new ListViewItem();
        ...
        private void btnUrunEkleKaldir_Click_1(object sender, EventArgs e)
        {
