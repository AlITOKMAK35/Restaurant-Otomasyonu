...
namespace PizzaciSon.Ayarlar
{
    public partial class MasaEkleKaldir : Form
    {
        ...
        private void btnKaldir_Click(object sender, EventArgs e)
        {
            ...
            bg.Open();
            guncel = new SqlCommand("deleteListboxKontrol where masaNo=@masaNo and masaYeri=@masaYeri",bg);
            guncel.Parameters.AddWithValue("@masaNo", masaNo);
            guncel.Parameters.AddWithValue("@masaYeri", masaYeri);
            guncel.ExecuteNonQuery();
            bg.Close();
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            if (yeniMasaYeri != "" && yeniMasaNo != 0)
            {
                ...
                bg.Open();
                guncel = new SqlCommand("insert int ListboxKontrol(listbox, tutar, durum, masaYeri, masaNo, fisNotu) values ('',0,'false',@masaYeri, @masaNo,'')", bg);
                guncel.Parameters.AddWithValue("@masaNo", yeniMasaNo);
                guncel.Parameters.AddWithValue("@masaYeri", yeniMasaYeri);
                guncel.ExecuteNonQuery();
                bg.Close();
        ...
        private void btnBxUrunEkleKaldir_Click(object sender, EventArgs e)
        {

        }

        private void btnUrunDuzenle_Click_1(object sender, EventArgs e)
        {
