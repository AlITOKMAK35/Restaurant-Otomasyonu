...
namespace PizzaciSon
{
    public partial class GunlukGiderler : Form
    {
        ...
        private void txtBxPersonelAd_Click(object sender, EventArgs e)
        {
            txtBxPersonelAd.Text = "";
            txtBxPersonelAd.ForeColor = Color.Black;
        }

        private void txtBxPersonelFiyat_Click(object sender, EventArgs e)
        {
            txtBxPersonelFiyat.Text = "";
            txtBxPersonelFiyat.ForeColor = Color.Black;
        }

        private void txtBxPersonelFiyat_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtBxMarket_Click(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
       ...
       private void btnPersonel_Click(object sender, EventArgs e)
        {
            ...
            if (txtBxPersonelAd.Text != "" && txtBxPersonelAd.Text != "Personel Adı")
            {
                personelAd = txtBxPersonelAd.Text;
                if (txtBxPersonelFiyat.Text != "" && txtBxPersonelFiyat.Text != "Ücret")
                {
                    personelUcret = Convert.ToInt32(txtBxPersonelFiyat.Text);
                    bg.Open();
       ...
       private void btnMarketMutfak_Click(object sender, EventArgs e)
        ...
        private void lstViewpersonel_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (lstViewPersonel.SelectedItems.Count == 1)
            {
                for (int i = 0; i < 2; i++)
                {
                    items = lstViewPersonel.SelectedItems[0].SubItems[0].Text.ToString();
                    if (i == 0)
        ...
        private void lstMarketMutfak_SelectedIndexChanged(object sender, EventArgs e)
        {
            seciliPersonelAd = "";
