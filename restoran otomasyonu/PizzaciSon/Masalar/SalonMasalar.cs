using PizzaciSon.Class;
using PizzaciSon.Siparis;
using System;
...
using PizzaciSon.Raporlar;
using PizzaciSon.Masalar;
using PizzaciSon.Ayarlar;
using PizzaciSon.StokTakibi;





namespace PizzaciSon.Masalar
{
    public partial class SalonMasalar : Form
    {
        ...
        public void SalonMasalar_Load(object sender, EventArgs e)
        {
