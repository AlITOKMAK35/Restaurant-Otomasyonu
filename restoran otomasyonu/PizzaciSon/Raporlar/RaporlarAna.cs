...
namespace PizzaciSon.Raporlar
{
    public partial class RaporlarAna : Form
    {
        ...
        private void btnZRapor_Click_1(object sender, EventArgs e)
        {

        }

        private void btnAdisyonRapor_Click_1(object sender, EventArgs e)
        {

        }

        private void btnPaketServis_Click_1(object sender, EventArgs e)
        {

        }

        private void btnBahşiş_Click_1(object sender, EventArgs e)
        {
